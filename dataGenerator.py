...
class DataGenerator(Sequence):
    ...
    def __init__(self, directory, batch_size=1, shuffle=False, data_augmentation=True, one_hot=False, target_frames=32, sample=False, normalize_ = True, background_suppress = False, resize=320, frame_diff_interval=1, dataset=None, mode="only_differences"): 
    ...
    def random_crop(self, video, prob=0.5):
        ...
        # gives back a randomly cropped 224 X 224 from a video with frames 320 x 320         kan mamchitch raw error lina
    ...
    def load_data(self, path):
        ...
        if differences:
            ...
            assert (diff_data.shape == (self.target_frames - self.frame_diff_interval, self.resize, self.resize, 3)), (str(diff_data.shape), str((self.target_frames - self.frame_diff_interval, self.resize, self.resize, 3)))
